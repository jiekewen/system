        ...
        <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
            ...
            <div class="alerm_box">
                ...
                <div class="alerm_select">
                    <el-row>
                        <el-select class="alermAdd-el-select" v-model="value" placeholder="新工厂配电室" @change="onSelected">
                            <el-option
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.$http
            .get('alarmSet/pointsByShAndVt?switchhouse='+this.switchhouse+'&vt='+this.vt)
            .then(response => {
